...
export default function TaskCompleteModal({
  ...
  return (
    <div className="max-w-[390px] w-full fixed top-0 bottom-0 bg-black/50 flex justify-center items-center z-50">
      <div className="flex flex-col items-center bg-white p-6 rounded-lg w-[90%]">
        ...
        <div className="flex gap-2 my-4">
          ...
          <div className="flex items-center gap-1 text-white px-1 py-0.5 rounded-sm font-semibold bg-main-100">
            <FaCirclePlus size={15} />
            <span className="font-semibold text-xs">{200}xp</span>
          </div>
          <div className="flex items-center gap-1 bg-white px-1 rounded-sm font-normal text-main-100">
            <FaFire size={15} className="scale-x-[-1]" />
            <span className="text-neutral-900 text-xs">{10}</span>
          </div>
        </div>
        <button
          className="bg-main-100 w-full text-white rounded-lg py-2.5 font-semibold text-xl"
