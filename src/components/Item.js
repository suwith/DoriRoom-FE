...
export default function Item({ name = '장미 머리띠', price = 8 }) {
  return (
    <div className="flex flex-col gap-2">
      <div className="relative bg-neutral-100 rounded-md w-[110px] h-[126px] ring-1 ring-neutral-300/30">
        <GiShirt className="absolute top-2/5 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-black w-12 h-12" />
